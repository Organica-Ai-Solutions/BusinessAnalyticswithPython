...
DB_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'retail.db')
    ...
    while current_date < datetime.now():
        ...
        for store_id in range(1, 11):
            ...
            for dept_id in range(1, 11):
                ...
                dec_toy_boost = 2.0 if (dept_id == 10 and current_date.month == 12) else 1.0
                
                # Weekly sales calculation with some randomness
                weekly_sales = baseline * store_factor * month_factor * holiday_boost * dec_toy_boost
